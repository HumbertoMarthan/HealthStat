package br.com.projeto.report.util;
...
public abstract class BeanReportView extends BeanViewAbstract {
	...
	public void setParametrosRelatorio(HashMap<Object, Object> parametroRelatorio) {
		this.parametrosRelatorio = parametroRelatorio;
	}
